      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-gray-400">
                ...
                <span>cstc@sau.int</span>
              </div>
              
              <div className="flex items-center space-x-2 text-gray-400">
                <MapPin className="h-4 w-4" />
                <span>PCM Block, South Asain University, New Delhi, 110068 </span>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 sm:mt-0">
            <a href="https://github.com/cstcsau" className="text-gray-400 hover:text-white transition-colors">
              <Github className="h-5 w-5" />
            </a>
            <a href="https:/www.linkedin.com/company/cstcsau"  className="text-gray-400 hover:text-white transition-colors">
